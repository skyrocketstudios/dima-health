	...
	protected function addPostsListPicker($name,$value,$title,$extra){
		...
		*/
		...
		if($isWpmlExists == true){
			...
			$arrLanguages = array_flip($arrLanguages);
			
			$this->addSelect($name."_lang", $arrLanguages, esc_html__("Language", "unlimited_elements"), $activeLanguege, $params);
		}
		*/
