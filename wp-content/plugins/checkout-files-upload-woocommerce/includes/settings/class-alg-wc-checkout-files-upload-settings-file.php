	...
	function get_settings() {
		...
		$settings = array(
			...
			array(
				...
				'desc_tip' => __( 'Ignored if "Validate image dimensions" option is set to "Do not validate".', 'checkout-files-upload-woocommerce' ),
			...
			array(
				'title'    => __( 'Upload button', 'checkout-files-upload-woocommerce' ),
				'desc_tip' => __( 'You can use shortcodes here.', 'checkout-files-upload-woocommerce' ),
			...
			array(
				'title'    => __( 'Remove button', 'checkout-files-upload-woocommerce' ),
				'desc_tip' => __( 'You can use shortcodes here.', 'checkout-files-upload-woocommerce' ),
			...
			array(
				...
				'default'  => __( 'Wrong image dimensions: "%s"! Current: %current_width% x %current_height%. Required: %required_width% x %required_height%.', 'checkout-files-upload-woocommerce' ),
				'type'     => 'textarea',
				'css'      => 'width:100%',
				'alg_wc_cfu_raw' => true,
			),
			...
			array(
				'title'    => __( 'No file selected', 'checkout-files-upload-woocommerce' ),
