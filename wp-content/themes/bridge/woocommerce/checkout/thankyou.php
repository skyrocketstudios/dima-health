...
<div class="woocommerce-order">
	...
	<?php if ( $order ) :
		...
		<?php else : ?>
			...
			<?php if($order->needs_payment() == "1" || $order->needs_payment()) { ?>
				<div  class="notice-dragonpay-pending"> 
					<h2 class="status">Your payment is still <strong> Pending.</strong></h2> 
					
					<div class="otc-ob-note">
						<div><strong>If you will pay using Online Banking or Over-the-counter:</strong> </div>
						<span>Please follow the instructions we provided to your email for us to process your order.
						An email notification with confirmation will be sent to your email after we received and verified your payment. Thank you! </span>
					</div>

					<div class="cod-note">
						<div><strong>If you chose Cash-on-delivery:</strong> </div>
						<span>Allow us to process and confirm your order within 5-6 working days. Please prepare the amount upon delivery. Thank you! </span>
					</div>
				</div>
			<?php } ?>
