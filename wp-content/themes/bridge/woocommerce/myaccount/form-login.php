...
<div>
	<h2 class="login_head_title">Welcome to Dima!</h2>
</div>
...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<input type="submit" class="woocommerce-Button button custom_shop_button" name="login" value="<?php esc_attr_e( 'Log In', 'bridge' ); ?>" />
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
				...
				<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
					<input type="password" class="woocommerce-Input woocommerce-Input--text input-text placeholder login_password" placeholder="<?php esc_html_e('Password', 'bridge'); ?>" name="password" id="reg_password" />
				</p>
			<?php else : ?>
			...
			<p class="woocommerce-FormRow form-row">
				...
				<input type="submit" id="register_button" class="woocommerce-Button button custom_shop_button" name="register" value="<?php esc_attr_e( 'Register', 'bridge' ); ?>" />
			</p>
