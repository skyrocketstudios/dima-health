...
<form class="woocommerce-shipping-calculator shipping_calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
        ...
        <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
            <p class="form-row form-row-wide" id="calc_shipping_country_field">
                <select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state country_select" rel="calc_shipping_state">
                    <option value=""><?php esc_html_e( 'Select a country&hellip;', 'bridge' ); ?></option>
                    <?php
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button custom_shop_button"><?php esc_html_e( 'Update', 'bridge' ); ?></button></p>
